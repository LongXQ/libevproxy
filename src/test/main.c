...
void writeProc(int fd,void *clientData){
	char buf[1024]="dfdfdfdfdfdfdfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff";
...
int main(int argc,char**argv){
	...
	user u;
	u.a=0;
	event_proxy *proxy=createEventProxy(100);
	if(proxy==NULL){
